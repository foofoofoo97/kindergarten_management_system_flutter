...
import 'package:kiki/owner_function_pages/manage_posts/manage_posts_page.dart';
import 'package:kiki/ui_components/functional_ui.dart';

class EmployeeManagePostsPage extends StatefulWidget {
  @override
  _EmployeeManagePostsPageState createState() => _EmployeeManagePostsPageState();
}

class _EmployeeManagePostsPageState extends State<EmployeeManagePostsPage> {
  ...
  Widget build(BuildContext context) {
    switch(kindergartenProfile.canPosts.elementAt(kindergartenProfile.employeeUID.indexOf(employeeProfile.uid))){
      case 0:
        return Scaffold(
          ...
          body: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text('Access To Posts Management Feature Is Not Permitted By Kindergarten Owner',
